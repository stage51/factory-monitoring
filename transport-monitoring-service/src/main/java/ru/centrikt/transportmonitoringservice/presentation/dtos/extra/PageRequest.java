...
public class PageRequest {
    ...
    @Schema(description = "Фильтр по датам, который выводит значения между двумя заданным датам в формате ISO. Если нет первой или второй даты и их значение null, фильтрует по наименьшей дате в системе или наибольшей соответственно")
