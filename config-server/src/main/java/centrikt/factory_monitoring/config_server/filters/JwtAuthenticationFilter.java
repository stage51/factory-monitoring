package centrikt.factory_monitoring.config_server.filters;


import centrikt.factory_monitoring.config_server.exceptions.InvalidTokenException;
import centrikt.factory_monitoring.config_server.utils.jwt.JwtTokenUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.startsWith("/api/v1/config-server/config/client") ||
