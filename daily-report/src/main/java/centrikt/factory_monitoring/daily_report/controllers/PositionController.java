...
import centrikt.factory_monitoring.daily_report.utils.ftp.FTPUtil;
...
public class PositionController implements centrikt.factory_monitoring.daily_report.controllers.docs.PositionController {
    ...
    public PositionController(PositionService positionService, FTPUtil ftpUtil) {
        ...
        log.info("PositionController initialized with PositionService: {}, FTPUtil: {}", positionService.getClass().getName(), ftpUtil.getClass().getName());
    }
