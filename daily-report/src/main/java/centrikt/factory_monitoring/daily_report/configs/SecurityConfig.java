    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(
                        authz -> authz
                                .requestMatchers(HttpMethod.POST, "/api/v1/daily-report/positions/fetch", "/api/v1/daily-report/products/fetch").authenticated()
                                .requestMatchers(HttpMethod.GET, "/api/v1/daily-report/positions/**", "api/v1/daily-report/products/**").authenticated()
