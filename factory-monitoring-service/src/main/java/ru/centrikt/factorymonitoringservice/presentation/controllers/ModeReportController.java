...
import ru.centrikt.factorymonitoringservice.presentation.controllers.docs.AbstractModeReportController;
...
@RestController
@RequestMapping(value = "api/v1/factory-monitoring/mode-report")
@Slf4j
