...
import ru.centrikt.factorymonitoringservice.presentation.controllers.docs.AbstractDailyReportController;
...
@RestController
@RequestMapping(value = "api/v1/factory-monitoring/daily-report")
@Slf4j
public class DailyReportController implements AbstractDailyReportController {
    ...
    public ResponseEntity<List<ReportStatusResponse>> checkLines(@RequestParam String taxpayerNumber) {
        ...
        return ResponseEntity.ok(dailyReportService.getReportStatuses(taxpayerNumber));
    }
}
