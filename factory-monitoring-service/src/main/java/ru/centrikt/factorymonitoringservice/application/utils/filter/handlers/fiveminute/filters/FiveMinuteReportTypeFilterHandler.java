...
@Component
public class FiveMinuteReportTypeFilterHandler implements CustomFilterHandler<FiveMinuteReport> {
    @Override
    ...
    public void applyFilter(Root<FiveMinuteReport> root, CriteriaBuilder cb, List<Predicate> predicates, String rawValue) {
        ...
        predicates.add(cb.equal(root.get("position").get("product").get("type"), type));
    }
}
